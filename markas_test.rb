...
class MailTest < Test::Unit::TestCase
    ...
    def test_same_as_min
        assert_equal "1 piecu centu marka, 1 trīs centu marka", @same_as_min.validate, "8 should be 1 five cent and 1 three cent stamps"
    end
    ...
    def test_buy_with_two_coins
        assert_equal "21 piecu centu marka, 2 trīs centu markas", @bought_many.validate, "111 should be 21 five cent and 2 three cent stamps"
    end
